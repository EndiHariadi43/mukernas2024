<footer class="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
    ...
    <div class="container">
        ...
        <div class="w-full px-4 md:w-2/3 lg:w-1/2">
            ...
            <a href="kebijakan_privasi.php" rel="nofollow noopener" target="_blank" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
                Kebijakan Privasi
            </a>
            <a href="penafian.php" rel="nofollow noopener" target="_blank" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
                Penafian
            </a>
            <a href="persyaratan_layanan.php" rel="nofollow noopener" target="_blank" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
            Persyaratan layanan
            </a>
            </div>
            </div>
