<footer class="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
    ...
    <div class="-mx-4 flex flex-wrap">
        ...
        <div class="mb-10 w-full">
            ...
            <img src="<?php echo ASSETS_URL; ?>images/logo/logo-white.png" alt="logo" class="max-w-full" />
            </a>
            <p class="mb-8 max-w-[270px] text-base text-gray-7"> Forum Komunikasi Pendidikan Kesetaraan Pada Pondok Pesantren Salafiyah. </p>
        <div class="flex items-center -mx-3">
            <a href="https://www.facebook.com/sharer/sharer.php?u=https://fk-pkpps.ponpes.id" target="_blank" class="px-3 text-gray-7 hover:text-white">
            ...
            <a href="https://twitter.com/intent/tweet?url=https://fk-pkpps.ponpes.id" class="px-3 text-gray-7 hover:text-white">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="fill-current">
                <path
            ...
            <a href="https://www.linkedin.com/shareArticle?mini=true&url=https://fk-pkpps.ponpes.id" target="_blank" class="px-3 text-gray-7 hover:text-white">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="fill-current">
                <path
        ...
        <div class="mb-10 w-full">
            <h4 class="mb-9 text-lg font-semibold text-white">Ada Apa</h4>
            <ul>
            <li>
                <a href="<?php echo BASE_URL; ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary"> Beranda </a>
            </li>
            <li>
                <a href="<?php echo BASE_URL; ?>gallery" class="mb-3 inline-block text-base text-gray-7 hover:text-primary"> Galeri </a>
            </li>
            <li>
                <a href="<?php echo BASE_URL; ?>donasi" class="mb-3 inline-block text-base text-gray-7 hover:text-primary"> Donasi </a>
            </li>
            </ul>
        </div>
        </div>
        ...
        <div class="mb-10 w-full">
            <h4 class="mb-9 text-lg font-semibold text-white">Aturan</h4>
            <ul>
            <li>
                <a href="<?php echo BASE_URL; ?>cookies" class="mb-3 inline-block text-base text-gray-7 hover:text-primary"> Cookies</a>
            </li>
            <li>
                <a href="<?php echo BASE_URL; ?>kebijakan_privasi" class="mb-3 inline-block text-base text-gray-7 hover:text-primary"> Kebijakan Privasi </a>
            </li>
            <li>
                <a href="<?php echo BASE_URL; ?>persyaratan_layanan" class="mb-3 inline-block text-base text-gray-7 hover:text-primary"> Persyaratan layanan </a>
            </li>
            <li>
                <a href="<?php echo BASE_URL; ?>penafian" class="mb-3 inline-block text-base text-gray-7 hover:text-primary"> Penafian </a>
            </li>
            </ul>
        </div>
        </div>
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
        <div class="mb-10 w-full">
            <h4 class="mb-9 text-lg font-semibold text-white"> Produk Kami </h4>
            <ul>
            <li>
                <a href="https://ujianpkpps.online/" rel="nofollow noopener" target="_blank" class="mb-3 inline-block text-base text-gray-7 hover:text-primary"> Aplikasi Ujian Online </a>
            </li>
            </ul>
        </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="w-full px-4 md:w-2/3 lg:w-1/2">
            ...
            <a href="<?php echo BASE_URL; ?>kebijakan_privasi" rel="nofollow noopener" target="_blank" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
                Kebijakan Privasi
            </a>
            <a href="<?php echo BASE_URL; ?>penafian" rel="nofollow noopener" target="_blank" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
                Penafian
            </a>
            <a href="<?php echo BASE_URL; ?>persyaratan_layanan" rel="nofollow noopener" target="_blank" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
            Persyaratan layanan
            </a>
            </div>
            </div>
        ...
        <div class="w-full px-4 md:w-1/3 lg:w-1/2">
            ...
            Developed by
            <a href="https://theorg.com/org/individual-software/org-chart/endi-hariadi" rel="nofollow noopener" target="_blank"
    ...
    <span class="absolute left-0 top-0 z-[-1]">
        <img src="<?php echo ASSETS_URL; ?>images/footer/shape-1.svg" alt="" />
    </span>
    <span class="absolute bottom-0 right-0 z-[-1]">
        <img src="<?php echo ASSETS_URL; ?>images/footer/shape-3.svg" alt="" />
    </span>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            foreach ($events as $event) {
                list($lat, $lng) = explode(',', htmlspecialchars($event['location']));
                echo "initMap('" . htmlspecialchars($event['id']) . "', " . $lat . ", " . $lng . ");";
            }
            ?>
        });
    </script>