...
$admins = $userModule->getUsersByRole('Admin');
...
<body>
    ...
    <section class="pt-20 pb-10 lg:pt-[120px] lg:pb-20 dark:bg-dark">
      <div class="container">
      <p class="max-w-[370px] text-base text-body-color dark:text-dark-6 pb-10"> Daftar Akun Admin </p>
        ...
        <?php foreach ($admins as $admin): ?>
          <div class="w-full px-4 md:w-1/3 lg:w-1/4">
            <div class="mb-10 wow fadeInUp group" data-wow-delay=".15s">
              <div>
                <h3>
                  <a href="blog-details.html" class="inline-block mb-4 text-xl font-semibold text-dark dark:text-white hover:text-primary dark:hover:text-primary sm:text-2xl lg:text-xl xl:text-2xl"> <?php echo htmlspecialchars($admin['name']); ?> </a>
                </h3>
                <p class="max-w-[370px] text-base text-body-color dark:text-dark-6"> <?php echo htmlspecialchars($admin['email']); ?> </p>
